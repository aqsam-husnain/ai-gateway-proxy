...
export class ClaudeApiService {
    ...
    createClient() {
        ...
        // Disable system proxy to avoid HTTPS proxy errors
    ...
    async callApi(endpoint, body, isRetry = false, retryCount = 0) {
        ...
        try {
            ...
            // For Claude API, 401 usually means invalid API Key, no retry
    ...
    async listModels() {
        ...
        // Claude API does not have a direct /models endpoint to list all models.
        // Typically, you need to hardcode the supported models based on Anthropic's documentation.
        // Here we return some common Claude models as examples.
        const models = [
