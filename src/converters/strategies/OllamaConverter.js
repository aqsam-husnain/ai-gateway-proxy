/**
 * Ollama Converter
 * Handles conversion between Ollama protocol and other protocols
 */
...
/**
 * Ollama Converter Class
 * Implements conversion from Ollama protocol to other protocols
 */
export class OllamaConverter extends BaseConverter {
    ...
    /**
     * Convert request - Ollama -> other protocols
     */
    ...
    /**
     * Convert response - other protocols -> Ollama
     */
    ...
    /**
     * Convert stream response chunk - other protocols -> Ollama
     */
    ...
    /**
     * Convert model list - other protocols -> Ollama
     */
    ...
    // =========================================================================
    // OpenAI/Claude/Gemini -> Ollama Conversion
    // =========================================================================

    /**
     * OpenAI/Claude/Gemini response -> Ollama chat response
     */
    ...
    /**
     * OpenAI/Claude/Gemini generate response -> Ollama generate response
     */
    ...
    /**
     * OpenAI/Claude/Gemini stream chunk -> Ollama stream chunk
     */
    ...
    /**
     * OpenAI/Claude/Gemini stream chunk -> Ollama generate stream chunk
     */
    ...
    /**
     * OpenAI/Claude/Gemini model list -> Ollama tags
     */
    ...
    toOllamaShowResponse(modelName) {
        ...
        let family = 'Ollama';  // IMPORTANT: Capital letter, as Copilot expects!
